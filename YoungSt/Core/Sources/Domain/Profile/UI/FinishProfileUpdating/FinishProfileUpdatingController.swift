...
final class FinishProfileUpdatingController: UIHostingController<EditProfileScene>, ClosableController {
    ...
    init(env: EditProfileEnvironment) {
        let store = Store(initialState: EditProfileState(shouldFetchProfile: false),
