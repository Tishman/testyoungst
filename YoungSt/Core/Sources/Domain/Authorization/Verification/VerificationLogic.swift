...
let verificationReducer = Reducer<VerificationState, VerificationAction, VerificationEnviroment>
    .combine(codeEnterReducer.pullback(state: \.codeEnter, action: /VerificationAction.codeEnter, environment: { _ in }),
